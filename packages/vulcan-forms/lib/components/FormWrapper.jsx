...
class FormWrapper extends PureComponent {
  ...
  UNSAFE_componentWillMount(){
    // NOT instantiate the wrapped component in constructor, not in render
  ...
  UNSAFE_componentWillReceiveProps(nextProps){
    ...
    const shouldReset = nextProps.documentId && !this.props.documentId || !nextProps.documentId && this.props.documentId || nextProps.documentId !== this.props.documentId
